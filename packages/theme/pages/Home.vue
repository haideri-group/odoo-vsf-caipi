      ...
      heroes: [
        {
          ...
          image: "/homepage/full_width_banner.png",
        },
        {
          title: "Colorful summer dresses are already in store",
          subtitle: "SUMMER COLLECTION 2020",
      ...
      banners: [
        {
          ...
          buttonText: "Shop now",
          image: "/homepage/bannerCaipiF.png",
          class: "desktop-only",
        },
        {
          slot: "banner-B",
          ...
          description:
            "Find stunning women's cocktail dresses and party dresses. Stand out in lace and metallic cocktail dresses from all your favorite brands.",
          buttonText: "Shop now",
          image: "/homepage/bannerCaipiE.png",
          class: "desktop-only",
        },
        {
          slot: "banner-C",
          ...
          image: "/homepage/bannerCaipiC.png",
        },
        {
          slot: "banner-D",
          subtitle: "Summer Sandals",
          title: "Eco Sandals",
          image: "/homepage/bannerCaipiD.png",
        },
      ],
      products: [
        {
